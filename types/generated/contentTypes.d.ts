...
export interface ApiProductsSliderProductsSlider extends Schema.CollectionType {
  collectionName: 'products_sliders';
  info: {
  ...
  attributes: {
    tag: Attribute.String & Attribute.Required & Attribute.Unique;
    slide: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::products-slider.products-slider',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
